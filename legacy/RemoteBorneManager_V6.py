...
"""
RemoteBorneManager_V6.py
---------------------------------------------------------
Application principale RemoteBorne.

- Navigation filesystem robuste (posixpath)
- Download / Edit / Print via SCP
- Restart services fiable
- Watchdog alive stable
- Layout identique à la V1 (logos + browser gauche, panneau contrôle droite, logs en bas)
---------------------------------------------------------
"""
...
class RemoteBorneApp:
    def __init__(self, config: configparser.ConfigParser):
        ...
        try:
            ...
            # Fallback si zoomed pas supporté
            try:
    ...
    def on_ssh_event(self, event_type, data):
        """
        Callback appelé par SSHManager pour notifier les changements d'état.
    ...
    def open_network_config(self):
        ...
        def on_saved():
            try:
                ...
                if changed:
                    # Demander si on redémarre maintenant
                    msg = (
        ...
        # Appeler le GUI réseau avec callback si possible
        try:
            network_config.open_network_config(self.root, on_saved)
        except TypeError:
            # Ancienne signature -> pas de callback; on relit quand même après
            try:
    ...
    def restart_application(self):
        """
        Restart proprement l'application.
        """
